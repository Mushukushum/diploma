...
import com.example.diploma.statistics.StatisticsRepository
...
class StatisticsViewModel @Inject constructor(
    ...
    private val _finances = MutableStateFlow<List<FinanceStatistics>>(emptyList())
    val finances: StateFlow<List<FinanceStatistics>> = _finances
